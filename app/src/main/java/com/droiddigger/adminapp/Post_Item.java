...
public class Post_Item {
    ...
    public Post_Item(String title, String imageUrl, String userName, String etDay, String status, String lat, String longt, String timestamp, String solveDate, String key, String solution, String urgency) {
        this.title = title;
    ...
    public Map<String, Object> toMap() {
        ...
        result.put("etDay", etDay);
        result.put("lat", lat);
        result.put("longt", longt);
